...
*/
    ...
    void setupMoons(String reason) {
        ...
        prospit = new Moon.fromWeightedThemes(prospitRing, null, "Prospit", prospitThemes, this, Aspects.LIGHT, session_id, ReferenceColours.PROSPIT_PALETTE);
        ...
        derse = new Moon.fromWeightedThemes(derseRing, null, "Derse", derseThemes, this, Aspects.VOID, session_id +1, ReferenceColours.DERSE_PALETTE);
        // ;
