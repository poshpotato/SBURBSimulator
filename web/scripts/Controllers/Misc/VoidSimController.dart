...
class VoidSimController extends SimController {
  VoidSimController() : super();
  ...
  void easterEggCallBack(Session session) {
    VoidSession ds = (session as VoidSession);
  ...
  void shareableURL() {
    ...
    String str = '<div class = "links"><a href = "void_index.html?seed=$initial_seed&$params">Shareable URL </a> &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp <a href = "character_creator.html?seed$initial_seed&$params" target="_blank">Replay Session  </a> &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp<a href = "void_index.html">Random Session URL </a> </div>';
