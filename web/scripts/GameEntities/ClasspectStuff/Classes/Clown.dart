...
class Clown extends SBURBClass {
    ...
    void initializeItems() {
        items = new WeightedList<Item>()
            ..add(new Item("Gun",<ItemTrait>[ ItemTraitFactory.METAL,ItemTraitFactory.CLASSY,ItemTraitFactory.IRONICFAKECOOL],shogunDesc: "You Gonna Fire That Little Man?.",abDesc:"It's a gun."))
